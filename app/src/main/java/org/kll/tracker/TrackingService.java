...
public class TrackingService extends Service {
    ...
    private void incrementTrackId(){
        sharedPrefs.edit().putInt("prefmaxtrack",(sharedPrefs.getInt("prefmaxtrack",0)+1)).commit();
    }
	...
	public boolean sendData() {
		...
		if (networkType.equals("wifi")) {
			...
			if (isWifiOn()) {
				...
				Toast.makeText(
						getBaseContext(),
						getResources().getString(R.string.no_internet_sms_disabled),
						Toast.LENGTH_LONG).show();
				return false;
			...
			if (isWifiOn()) {
				...
				if (currentLocation != null) {
                    ...
                    String trackId = String.valueOf(sharedPrefs.getInt("prefmaxtrack",0));
                    Log.i("TRACKID",trackId);
					String message = "trackerapp,track," + id + "," + name + ","
